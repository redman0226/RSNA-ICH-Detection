...
if __name__ == '__main__':
    ...
    inputfolder = 'TestingData'
    imagefolder = 'TestingData_png'
    print(glob(inputfolder+'/*'))
    if not os.path.exists(imagefolder):
        os.mkdir(imagefolder)
    prepare_images_njobs(glob(inputfolder + '/*'), imagefolder + '/')
    #breakpoint()
    '''
    ...
    for seq in seqs:
        ...
        if not os.path.exists(outfolder):
            os.mkdir(outfolder)
        prepare_images_njobs(glob(folder+'/*'), outfolder+'/')
    '''